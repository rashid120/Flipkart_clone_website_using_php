            ...
            <!-- User View Delivered Order Page -->
...
<?php
    ...
    ON users.id = orders.user_id WHERE users.id = '$user_id' AND o_delivered = 'Delivered'";
    ...
    <div class="omain">
        ...
        <div class="item">
            <div class="status">
                ...
                <div><input type="checkbox" onclick="ashow()" checked> Delivered</div>
