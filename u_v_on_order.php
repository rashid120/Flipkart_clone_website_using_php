            ...
            <!-- User View On The Way order Page-->
<?php
    include("./connect.php");
    session_start();
    ...
    ON users.id = orders.user_id WHERE users.id = '$user_id' AND o_status = 'Conform' AND o_delivered != 'Delivered' AND c_status = 0";
    ...
    <div class="omain">
        ...
        <div class="item">
            <div class="status">
                ...
                <div><input type="checkbox" onclick="ashow()" checked> On the way</div>
