...
<?php
    ...
    ON users.id = orders.user_id WHERE users.id = '$user_id' AND orders.c_status = 1";
...
<body style="background-color: #ddd;">
    ...
    <div class="omain">
        ...
        <div class="item">
            <div class="status">
                ...
                <div><input type="checkbox" onclick="ashow()" checked> Cancelled</div>
            ...
            <div class="prod">
                ...
                <div class="o-card">
                    ...
                    <div style="line-height:25px; width:270px; overflow-x:scroll;">
                        <?php echo $row['name'] ?><br>
                        Rs : - <?php echo $row['price'] ?><br>
                        Items = <?php echo $row['o_quantity'] ?>
                    </div>
                    <div class="con">
                        <?php
                            if($row['c_status'] == 0){ // this condition for cancel item
                                ...
                                if($row['o_delivered'] == ''){
                                    ...
                                    echo "Your product has reached you. <font color='#28f'>Good Luck</font>";
                                }
                                //end order status
    ...
    <script>
        function cancel(){
            var cl = prompt("Order cancel karne ki Wajah bataw ?", "requared");
            if(cl){
